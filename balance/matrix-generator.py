...
#'hexanoicacid2_iostatus.csv', \
#'heptanoicacid2_iostatus.csv', \
#'octanoicacid2_iostatus.csv', \
#'nonanoicacid_iostatus.csv', \
#'decanoicacid2_iostatus.csv', \
#'undecanoicacid2_iostatus.csv', \
#'dodecanoicacid2_iostatus.csv', \
#'tridecanoicacid2_iostatus.csv', \
#'tetradecanoicacid2_iostatus.csv', \
#'nonanoicacid2_iostatus.csv', \
'decanoicacid2_iostatus.csv', \
'undecanoicacid2_iostatus.csv', \
'dodecanoicacid2_iostatus.csv', \
'tridecanoicacid2_iostatus.csv', \
'tetradecanoicacid2_iostatus.csv', \
'pentadecanoicacid2_iostatus.csv', \
'hexadecanoicacid2_iostatus.csv', \
#'heptadecanoicacid2_iostatus.csv', \
#'octadecanoicacid2_iostatus.csv', \
#'LLeucine_iostatus.csv', \
#'LValine_iostatus.csv', \
#'LIsoleucine_iostatus.csv', \
#'3methylhexane_iostatus.csv', \
#'3methylheptane_iostatus.csv', \
#'2methylheptane_iostatus.csv'
#'1longchain_iostatus.csv', \
#'2longchain_iostatus.csv', \
#'3longchain_iostatus.csv', \
#'4longchain_iostatus.csv'
]
...
#'hexanoicacid2_reactions.txt', \
#'heptanoicacid2_reactions.txt', \
#'octanoicacid2_reactions.txt', \
#'nonanoicacid_reactions.txt', \
#'decanoicacid_reactions.txt', \
#'undecanoicacid_reactions.txt', \
#'dodecanoicacid_reactions.txt', \
#'tridecanoicacid_reactions.txt', \
#'tetradecanoicacid_reactions.txt', \
#'nonanoicacid2_reactions.txt', \
'decanoicacid2_reactions.txt', \
'undecanoicacid2_reactions.txt', \
'dodecanoicacid2_reactions.txt', \
'tridecanoicacid2_reactions.txt', \
'tetradecanoicacid2_reactions.txt', \
'pentadecanoicacid2_reactions.txt', \
'hexadecanoicacid2_reactions.txt', \
#'heptadecanoicacid2_reactions.txt', \
#'octadecanoicacid2_reactions.txt', \
#'LLeucine_reactions.txt', \
#'LValine_reactions.txt', \
#'LIsoleucine_reactions.txt', \
#'3methylhexane_reactions.txt', \
#'3methylheptane_reactions.txt', \
#'2methylheptane_reactions.txt'
