...
outputDir = 'output/Fig5b&d/'

outputFilenameEff = join(outputDir, 'jetfuel-efficiency - termination 2.csv')
outputFilenameFuelMassEff = join(outputDir, 'jetfuel-mass - termination 2.csv')
