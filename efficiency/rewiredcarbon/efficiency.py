...
# ------------------------------------------------------------------------------------------------ ## ------------------------------------------------------------------------------------------------ #
#def Calculate_Fuel_Mole_Efficiency(molecularWeightFuelMolecule, totalFuelProductionRate, \
#availableElectricalPower, totalElectricalPower, totalInputPower):
	...
	#massPerFuelMolecule = molecularWeightFuelMolecule/avogadroNumber
	#totalFuelMassProductionRate = totalFuelProductionRate*massPerFuelMolecule
	#totalFuelMoleProductionRate = totalFuelMassProductionRate*molecularWeightFuelMolecule
	
	#available_Electrical_to_Fuel_Mole_Efficiency = \
	#availableElectricalPower / totalFuelMoleProductionRate
	
#	total_Electrical_to_to_Fuel_Mole_Efficiency = \
#	totalElectricalPower / totalFuelMoleProductionRate

#	total_Input_Power_to_to_Fuel_Mole_Efficiency = totalInputPower / totalFuelMoleProductionRate

#	return available_Electrical_to_Fuel_Mole_Efficiency, \
#	total_Electrical_to_to_Fuel_Mole_Efficiency, total_Input_Power_to_to_Fuel_Mole_Efficiency
...
# ------------------------------------------------------------------------------------------------ #
#def Update_Output_Dict_with_Fuel_Mole_Efficiency(outputDict, molecularWeightFuelMolecule, \
#totalFuelProductionRate, availableElectricalPower, totalElectricalPower, totalInputPower):

#	import pdb
	
#	# Update the output dict with the fuel mole efficiency (moles of product per joule of input
#	# power). 
		
#	available_Electrical_to_Fuel_Mole_Efficiency, total_Electrical_to_to_Fuel_Mole_Efficiency, \
#	total_Input_Power_to_to_Fuel_Mole_Efficiency = \
#	Calculate_Fuel_Mole_Efficiency(molecularWeightFuelMolecule, totalFuelProductionRate, \
#	availableElectricalPower, totalElectricalPower, totalInputPower)

#	outputDict['effAvailElectricalFuelMoleEfficiency'] = \
#	available_Electrical_to_Fuel_Mole_Efficiency
#	outputDict['effTotalElectricalFuelMoleEfficiency'] = \
#	total_Electrical_to_to_Fuel_Mole_Efficiency
#	outputDict['effTotalPowerFuelMoleEfficiency'] = \
#	total_Input_Power_to_to_Fuel_Mole_Efficiency
