...
outputDir = 'output/Fig4a&c/'

outputFilenameEff = join(outputDir, 'jetfuel-efficiency - straightchain 2.csv')
outputFilenameFuelMassEff = join(outputDir, 'jetfuel-mass - straightchain 2.csv')
...
scenarioTableFileName = 'input/jetfuel-efficiency - straightchain 2.csv'
