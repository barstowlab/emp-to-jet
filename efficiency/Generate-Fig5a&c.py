...
outputDir = 'output/Fig5a&c/'

outputFilenameEff = join(outputDir, 'jetfuel-efficiency - all pathways 2.csv')
outputFilenameFuelMassEff = join(outputDir, 'jetfuel-mass - all pathways 2.csv')
...
scenarioTableFileName = 'input/jetfuel-efficiency - all pathways 2.csv'
